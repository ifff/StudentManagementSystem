...
<script language="javascript">
	function check(form){
		if (form.entr_time.value==""){
			alert("请输入年级！");
			form.entr_time.focus();
			return false;
		}
	}
</script>
...
<br/><br /><br />
<div align="center">
   <form id="form1" name="form1" method="post" action="acdemicDean?action=creditsstatistics" >
      <p>
      	<label for="entr_time">年级</label>
        <select name="entr_time" id="entr_time">
