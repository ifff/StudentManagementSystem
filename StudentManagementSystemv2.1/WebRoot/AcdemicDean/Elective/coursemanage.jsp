...
<div id="Function">
  <ul>
	    <li ><a href="../Elective/insertCourse.jsp"><img src="../../Images/elective_gym.png" /><br />增加可选课程</a></li>
        <li ><a href="../Elective/deleteCourse.jsp"><img src="../../Images/elective_speciality.png" /><br />删除可选课程</a></li>
        <li ><a href="../Elective/queryCourse.jsp"><img src="../../Images/recondition.png" /><br />查看当前可选课程</a></li>
  </ul>
</div>
