...
<div id="Function">
  <ul>
	<li id="studentinfo"><a href="EnrolmentInfo/index.jsp"><img src="../Images/personal.png" /><br />学籍信息</a></li>
    <li id="electiveinfo"><a href="Elective/index.jsp"><img src="../Images/elective.png" /><br />选课安排</a></li>
    <li id="achievementinfo"><a href="AchievementManagement/index.jsp"><img src="../Images/achievement.png" /><br />成绩管理</a></li>
	<li id="declaration"><a href="Declaration/index.jsp"><img src="../Images/elective_public.png"/><br />申报系统</a></li>
	<li id="evalCourse"><a href="EvalCourse/index.jsp"><img src="../Images/achievement.png" /><br />课程评估</a></li>
    <li id="declaration"><a href="Notification/index.jsp"><img src="../Images/elective_public.png"/><br />通知设置</a></li>
  </ul>
</div>
