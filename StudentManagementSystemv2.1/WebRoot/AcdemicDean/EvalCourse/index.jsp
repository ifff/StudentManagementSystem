...
<div id="Function">
  <ul>
	    <li ><a href="../EvalCourse/setEvalTime.jsp"><img src="../../Images/elective_gym.png" /><br />设置课程评估起始时间</a></li>
        <li ><a href="../EvalCourse/CheckResult.jsp"><img src="../../Images/recondition.png" /><br />查看课程评估情况</a></li>
  </ul>
</div>
