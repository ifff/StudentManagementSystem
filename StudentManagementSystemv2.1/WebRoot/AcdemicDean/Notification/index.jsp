...
<div id="Function">
  <ul>
	    <li ><a href="../Notification/insertNotification.jsp"><img src="../../Images/elective_gym.png" /><br />发布新通知</a></li>
        <li ><a href="../Notification/queryUpdateNotification.jsp"><img src="../../Images/elective_speciality.png" /><br />修改原有通知</a></li>
        <li ><a href="../Notification/queryNotification.jsp"><img src="../../Images/recondition.png" /><br />查看通知</a></li>
        <li ><a href="../Notification/queryDeleteNotification.jsp"><img src="../../Images/recondition.png" /><br />删除通知</a></li>
  </ul>
</div>
