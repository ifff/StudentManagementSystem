...
<div id="Function">
  <ul>
	<li ><a href="StudentManagement/index.jsp"><img src="../Images/personal.png" /><br />院系学生管理</a></li>
    <li ><a href="AchievementManagement/index.jsp"><img src="../Images/elective.png" /><br />院系成绩管理</a></li>
    <li ><a href="CourseManagement/index.jsp"><img src="../Images/achievement.png" /><br />院系课程管理</a></li>
	<li ><a href="AcdemicDeanInfo/index.jsp"><img src="../Images/elective_public.png"/><br />教务员信息管理</a></li>
	<li ><a href="NotificationManagement/index.jsp"><img src="../Images/achievement.png"/><br />通知管理</a></li>
  </ul>
</div>
