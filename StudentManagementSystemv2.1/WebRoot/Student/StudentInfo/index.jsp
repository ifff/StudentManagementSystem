...
<div id="Function">
  <ul>
	    <li id="studentinfo"><a href="../StudentInfo/studentInfo_query.jsp"><img src="../../Images/personal1.png" /><br />基本信息查看</a></li>
    <li id="electiveinfo"><a href="../StudentInfo/studentInfo_modify.jsp"><img src="../../Images/recondition.png" /><br />基本信息修改</a></li>
   <!--  <li id="achievementinfo"><a href="../AchievementInfo/index.jsp"><img src="../../Images/elective_gym.png" /><br />基本信息核对</a></li>        -->
  </ul>
</div>
